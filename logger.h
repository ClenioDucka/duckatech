...
constexpr uint8_t LOG_ENTRY_SIZE = 147; /**< The size of the live data packet. This MUST match ochBlockSize setting in the ini file. Bumped from 138 to 147 for the 9-byte AdaptationOutputChannels block (see adaptation.h). */
